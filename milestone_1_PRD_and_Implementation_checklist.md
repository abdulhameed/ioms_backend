...
| ☐ | All 7 Celery beat tasks registered in beat schedule; visible in Celery inspect | `celery inspect scheduled` shows all 7 | |
...
| **7** | **Notifications & Celery** | All 7 beat tasks; in-app API; async email | **7 NFY** | ☐ PASS |
